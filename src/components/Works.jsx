  ...
  return (
    <motion.div variants={fadeIn("up","spring",index * 0.5,0.75)}>
      ...
      <Tilt
        ...
        className="bg-tertiary p-3 rounded-2xl sm:w-[490px] w-full justify-center items-center">
          <div className="relative w-full h-[230px] overflow-hidden">
            <img
              src={image}
              alt={name}
              className="w-[480px] h-full object-cover rounded-2xl"
            />
          </div>
          <div className="mt-5">
    ...
    <>
      ...
      <div className="w-full flex">
         <motion.p
            ...
            className="mt-3 text-secondary text-[17px] max-w=3x leading-[30px]">
