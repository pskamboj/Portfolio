      ...
      <div className={`${styles.paddingX} absolute inset-0 top-[100px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText}text-white`}>
            Hi , I'm <span className="text-[#915eff]">Prabhjot Singh</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I'm an AI enthusiast and a visionary developer. <br className='sm:block hidden'/>
          </p>
        </div>
      </div>
      <ComputersCanvas />
        ...
        <a href="#about">
          <div className="w-[35px] h-[60px] rounded-3xl border-4 border-secondary flex justify-center items-start p-2">
            <motion.dev
              ...
              className="w-3 h-3 ropunded-full bg-secondary mb-1" 
              />
          </div>
        </a>
